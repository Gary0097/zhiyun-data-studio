  ...
  function DataStudio() {
    ...
    return h("div", { style: { padding: 22, height: "100%", overflow: "auto", background: "#f5f7fa" } },
      h("div", { style: { maxWidth: 1280, margin: "0 auto" } },
        h("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 } }, h("div", null, h("h2", { style: { margin: 0 } }, "企业数据分析中心"), h("div", { style: { color: "#667085" } }, "用统一数据生成经营看板、风险预警、趋势和可审阅报告")), h(antd.Button, { style: { marginRight: 8 }, onClick: function () { setAgentOpen(true); } }, zySpark(), " 问 Agent"), h(antd.Button, { onClick: refresh, loading: loading }, "刷新数据")),
